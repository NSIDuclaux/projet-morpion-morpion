...
class Mode_de_jeu_morpion(Tk):
    ...
    def __init__(self):
        ...
        bouton1v1 = Button(self, text="1 v 1", font=("Helvetica",20), height=3, width=6, command=lambda: self.creer_morpion1v1())
        bouton1v1.grid(column=0, row=1, sticky="nswe", padx=3, pady=3)

        bouton1vpc = Button(self, text="1 v Ordinateur", font=("Helvetica",20), height=3, width=6, command=lambda: self.creer_morpion1vPC())
        bouton1vpc.grid(column=1, row=1, sticky="nswe", padx=3, pady=3)
